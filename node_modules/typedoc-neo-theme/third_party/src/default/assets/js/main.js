...
(function (typedoc) {
    ...
    var FilterItemSelect = (function (_super) {
        ...
        FilterItemSelect.prototype.handleValueChange = function (oldValue, newValue) {
            ...
            this.$select.find('.tsd-select-label').text(this.$select
...
window.addEventListener('load', function () {
    if (document.querySelector('.tsd-navigation.outline')) {
        ...
        document.querySelector(navigationFilter).innerHTML +=
            renderSimpleHTMLRecursive(hierarchy_1);
    }
});
var typedoc;
(function (typedoc) {
    ...
    (function (search) {
        ...
        function updateResults() {
            ...
            for (var i = 0, c = Math.min(10, res.length); i < c; i++) {
                ...
                var name_1 = row.name;
                var fullName = row.parent + "." + name_1;
                if (row.parent)
                    name_1 = "<span class=\"parent\">" + row.parent + ".</span>" + name_1;
                var priority = false;
                for (var _i = 0, _a = this.priorityResults; _i < _a.length; _i++) {
                    ...
                    if (fullName.match(result.name)) {
                        priorityResults.push("<li class=\"" + row.classes + "\">" +
                            ("<a href=\"" + base + row.url + "\" class=\"tsd-kind-icon\">" + name_1 + "&emsp;|") +
                ...
                if (!priority) {
                    otherResults.push("<li class=\"" + row.classes + " low-priority\"><a href=\"" + base + row.url + "\">" + name_1 + "</li>");
                }
            }
...
(function (typedoc) {
    ...
    typedoc.$document.on(typedoc.pointerDown, function (e) {
        ...
        typedoc.hasPointerMoved = false;
        var t = (typedoc.pointerDown === 'touchstart' ?
...
(function (typedoc) {
    function getVendorInfo(tuples) {
        for (var name_2 in tuples) {
            if (!tuples.hasOwnProperty(name_2)) {
                continue;
            }
            if (typeof (document.body.style[name_2]) !== 'undefined') {
