...
exports.transformWhileStatement = (statement, context) => {
    return lua.createWhileStatement(lua.createBlock(utils_1.transformLoopBody(context, statement)), context.transformExpression(statement.expression), statement);
};
