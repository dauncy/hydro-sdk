...
var _default = (0, _iterateJsdoc.default)(({
    ...
    if (preferredTypes) {
      ...
      definedPreferredTypes = _lodash.default.values(preferredTypes).map(preferredType => {
        ...
        if (typeof preferredType !== 'object') {
          report('Invalid `settings.jsdoc.preferredTypes`. Values must be falsy, a string, or an object.');
        }
  ...
  scopeManager.__options.nodejsScope || scopeManager.isModule() ? globalScope.childScopes.reduce((arr, {
    ...
    return name;
  }) : []).concat(extraTypes).concat(typedefDeclarations).concat(definedTypes).concat(definedPreferredTypes).concat(closureGenericTypes);
