...
const validateParameterNames = (targetTagName, functionParameterNames, jsdoc, report) => {
  if (!jsdoc || !jsdoc.tags) {
    return false;
  }
...
const validateParameterNamesDeep = (targetTagName, jsdocParameterNames, report) => {
